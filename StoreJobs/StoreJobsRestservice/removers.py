...
def HtmlParser(data,job={}):
    ...
    itemsNotEqual=('POSITION PROFILE','POSITION DIMENSIONS AND QUALIFICATIONS','POSITION SUMMARY','Reporting Relationships:','Core Duties and Responsibilities:','OVERVIEW OF POSITION:','POSITION PURPOSE','About the Company:','REQUIREMENTS FOR POSITION:','Our Company:'
