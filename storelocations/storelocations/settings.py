"""
Django settings for storelocations project.
...
SECRET_KEY = '(o^0u*_wugb-lcy5wa3sw9=#m4h-ppn+)3+3ltuy1a=tf05o32'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [socket.gethostbyname(socket.gethostname()),"127.0.0.1"]
...
MIDDLEWARE = [
    # 'locationModifier.customMiddleware.GetIpMiddleware',
...
ROOT_URLCONF = 'storelocations.urls'
...
WSGI_APPLICATION = 'storelocations.wsgi.application'
